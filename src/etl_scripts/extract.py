...
from src.utils.exceptions import NextPageError, FailedRequestError, MissingStateError, FileCompactionError
from src.etl_scripts.utilities.rate_limit import RateLimiterHandler
from src.utils.log_service import progress_logger, error_logger
from src.config import config
from src.states import last_token, last_shard_path, last_extraction_result
...
class Extractor:
    ...
    def make_request(self):
        ...
        with open("src/states/last_extraction_result.py", "w") as f:
            f.write(
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if response.status_code == 200:
                    ...
                    with open("src/states/last_token.py", "w") as f:
                        f.write(
    ...
    def save_response(self, data: Dict):
        ...
        with open("src/states/last_shard_path.py", "w") as f:
            f.write(
